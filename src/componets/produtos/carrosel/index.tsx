...
for (let i = 0; i < itensPorPagina; i++) {
   ...
   function handleCloseModal() {
    ...
    return (
        ...
        <button onClick={handlePrev} className="btn-carrossel btn-carrossel-esquerda "><img src={setaEsquerda} alt="Seta esquerda" /></button>
        ...
        <button onClick={handleNext} className="btn-carrossel btn-carrossel-direita"><img src={setaDireita} alt="Seta direita" /></button>
